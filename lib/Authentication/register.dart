...
class _RegisterState extends State<Register> {
  ...
  Future<void> uploadAndSaveImage() async{
    if(_imageFile == null){
      ...
      _passwordController.text == _confirmPasswordController.text ? _emailController.text.isNotEmpty && _passwordController.text.isNotEmpty
          && _confirmPasswordController.text.isNotEmpty && _nameController.text.isNotEmpty ? uploadToStorage()
